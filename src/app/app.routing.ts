...
import { CodeGuard } from './shared/codeguard.service';
...
export const appRoutes: Route[] = [
    ...
    // Redirect signed in user to the '/dashboards/dashboard'
    // This is critical for GHL OAuth return handling
    {path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'dashboards/dashboard'},
    
    // For GHL OAuth callback - this will handle returns from GHL authentication
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
                ...
                {path: 'reporting', loadChildren: () => import('app/modules/admin/dashboards/analytics/analytics.module').then(m => m.AnalyticsModule)},
                {path: 'deals', loadChildren: () => import('app/modules/admin/dashboards/finance/finance.module').then(m => m.FinanceModule)},
                { 
                    path: 'propertydetails/:id', 
                    loadChildren: () => import('app/modules/admin/dashboards/crypto/crypto.module').then(m => m.CryptoModule), 
                    data: { renderMode: 'ssr' }
                  },
                  {path: 'adddeals', loadChildren: () => import('app/modules/admin/ui/forms/fields/fields.module').then(m => m.FormsFieldsModule)}

                  ,    
                                  {path: 'announcements', loadChildren: () => import('app/modules/admin/pages/activities/activities.module').then(m => m.ActivitiesModule)},
                {path: 'calendar', loadChildren: () => import('app/modules/admin/apps/tasks/tasks.module').then(m => m.TasksModule)},
                                {path: 'contacts', loadChildren: () => import('app/modules/admin/apps/contacts/contacts.module').then(m => m.ContactsModule)},
                                                {path: 'chat', loadChildren: () => import('app/modules/admin/apps/chat/chat.module').then(m => m.ChatModule)},
                {path: 'calendarr', loadChildren: () => import('app/modules/admin/apps/calendar/calendar.module').then(m => m.CalendarModule)},

                  {path: 'closedeals', loadChildren: () => import('app/modules/admin/ui/typography/typography.module').then(m => m.TypographyModule)}
            ...
            {path: 'pages', children: [
                ...
                // Maintenance
                {path: 'mlsdetails/:id', loadChildren: () => import('app/modules/admin/pages/maintenance/maintenance.module').then(m => m.MaintenanceModule),data: { renderMode: 'ssr' }},  
                ...
                // Profile
                {path: '', loadChildren: () => import('app/modules/admin/pages/profile/profile.module').then(m => m.ProfileModule)},
...
,  
            ...
            {path: '**', redirectTo: 'dashboards/dashboard'}
        ]
    }
];